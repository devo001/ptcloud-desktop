...
if(NEXTCLOUD_DEV)
    ...
    set( APPLICATION_NAME       "PtCloud" )
    set( APPLICATION_SHORTNAME  "PtCloud" )
    set( APPLICATION_EXECUTABLE "ptcloud" )
    set( APPLICATION_ICON_NAME  "${APPLICATION_SHORTNAME}" )
endif()

set( APPLICATION_CONFIG_NAME "${APPLICATION_EXECUTABLE}" )
set( APPLICATION_DOMAIN     "ptcloud.health" )
set( APPLICATION_VENDOR     "Gerhard vd Westhuizen, Nextcloud GmbH" )
set( APPLICATION_UPDATE_URL "https://updates.ptcloud.health/client/" CACHE STRING "URL for updater" )
set( APPLICATION_HELP_URL   "" CACHE STRING "URL for the help menu" )

if(APPLE AND APPLICATION_NAME STREQUAL "PtCloud" AND EXISTS "${CMAKE_SOURCE_DIR}/theme/colored/PtCloud-macOS-icon.svg")
    set( APPLICATION_ICON_NAME "PtCloud-macOS" )
...
set( APPLICATION_REV_DOMAIN "health.ptcloud.desktopclient" )
set( APPLICATION_VIRTUALFILE_SUFFIX "ptcloud" CACHE STRING "Virtual file suffix (not including the .)")
set( APPLICATION_OCSP_STAPLING_ENABLED OFF )
set( APPLICATION_FORBID_BAD_SSL OFF )

set( LINUX_PACKAGE_SHORTNAME "ptcloud" )
...
## Theming options
set(NEXTCLOUD_BACKGROUND_COLOR "#18396b" CACHE STRING "Default Nextcloud background color")
